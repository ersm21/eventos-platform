              ...
              <article key={quote.id} style={cardStyle}>
                <div style={quoteCompactRowStyle}>
                  ...
                  <div style={quoteCompactActionStyle}>
                    ...
                    <a
                      href={`/quote/${quote.id}?print=conduce`}
                      target="_blank"
                      rel="noreferrer"
                ...
                <div style={infoGridStyle}>
                  ...
                  <section style={subPanelStyle}>
                    ...
                    <p style={rowTextStyle}>
                      ...
                      {formatMoney(calculateTechnicalSupport(getQuoteBaseTotal(quote, itemsForQuote)))}
                    </p>
                    <p style={rowTextStyle}>
                ...
                <section style={{ ...subPanelStyle, marginTop: 16 }}>
                  ...
                  <div style={quoteItemEditorHeaderStyle}>
                    ...
                    <strong style={quoteItemsTotalStyle}>
                      Subtotal de artículos sin ITBIS: {formatMoney(getQuoteItemsTotal(itemsForQuote))}
                    </strong>
                  </div>
